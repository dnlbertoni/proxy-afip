...
class WSFE {
  ...
  //const CUIT = "30565887617";                 # CUIT del emisor de las facturas
  //const CERT = "../data/keys/certificadoCentro_6442083e8fa4a204.crt";                # The X.509 certificate in PEM format
  //const PRIVATEKEY = "../data/keys/privadaCE.key";          # The private key correspoding to CERT (PEM)
  const CUIT = "20268667033";                 # CUIT del emisor de las facturas
  const CERT = "../data/keys/certificadoDNL.crt";                # The X.509 certificate in PEM format
  const PRIVATEKEY = "../data/keys/privadaDNL.key";          # The private key correspoding to CERT (PEM)
  const TA =    "../data/xmlgenerados/TA.xml";        # Archivo con el Token y Sign
